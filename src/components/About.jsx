...
const About = () => {
  // destructure data
  const { pretitle, title, subtitle1,subtitle2,subtitle3, btnText, image } = aboutData;
  return (
      ...
      <div className='container mx-auto min-h-[620px]'>
        ...
        >
          ...
          >
            ...
            <p className='mb-8 max-w-[560px] capitalize'>{subtitle1}</p>
            <p className='mb-8 max-w-[560px]'>{subtitle2}</p>
            <p className='mb-8 max-w-[560px]'>{subtitle3}</p>
